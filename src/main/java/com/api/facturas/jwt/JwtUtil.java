...
public class JwtUtil {
	...
	//private String secret="spring"; .setSigningKey obsoleto para String cambia a Key
    private Key secret;
    ...
    */
    ...
    public Claims extractAllClaims(String token){
        //return Jwts.parser().setSigningKey(secret).parseClaimsJws(token).getBody(); .setSigningKey obsoleto
        return Jwts.parser()
    ...
    private String createToken(Map<String,Object> claims,String subject){
        return Jwts.builder()
                ...
                //.signWith(SignatureAlgorithm.HS256,secret).compact();  obsoleto se reemplaza por hmac
